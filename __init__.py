...
threeDayPull = """SELECT 
					...
					COALESCE(ROUND(ABS(((price7-price4)/ABS(price4)*.8))+ABS(((volume7-volume4)/ABS(volume4)*.2))/2,2),0) as Weight
...
@app.route('/about')
def about():
	return "1300+ low to medium risk Equities: Criteria: 1) 100M < Market Cap < 910B, 2) 300k < volume < MAX, 3) 0% < Rev Growth < Max 4) 1 < Beta < MAX"
